...
export const content: TemplateContent = {
  business: {
    name: "Haldwell & Carr",
    legalName: "Haldwell & Carr LLP",
    address: "118 Court Street, Suite 400\nPortsmouth, NH 03801",
    phone: "(603) 555-0148",
    email: "office@haldwellcarr.example",
    hours: [
  ...
  testimonials: [
    {
      quote:
        "I have used Haldwell & Carr for two business sales and a family trust. In every case the partner running the matter knew the file as well as I did. That is increasingly rare.",
      name: "Margaret W.",
